...
public class InsertionTest {
    ...
    //REF_HB
    @Test
    public void testInsertion_propose() throws Exception {
       ...
       Operation insertion = new Insertion(interventionFamily, ed, new Node(4), new Node(2), scoreFunction).propose();

        assertEquals(insertion.cliqueArgMaxC.get(0).getNumber(), 3);

    }

    @Test
    public void testInsertion_commit() throws Exception {
